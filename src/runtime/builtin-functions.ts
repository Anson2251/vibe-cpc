...
export const builtInFunctions: Record<string, Omit<RoutineInfo, 'name'>> = {
	LENGTH: defineBuiltIn([byValue('str', PseudocodeType.STRING)], PseudocodeType.INTEGER, (str) =>
		String(str).length,
	),
	...
	IS_NUM: defineBuiltIn([byValue('str', PseudocodeType.STRING)], PseudocodeType.BOOLEAN, (str) => {
	...
	DAY: defineBuiltIn([byValue('dateValue', PseudocodeType.DATE)], PseudocodeType.INTEGER, (dateValue) =>
		ensureDate(dateValue).getDate(),
	),
	MONTH: defineBuiltIn([byValue('dateValue', PseudocodeType.DATE)], PseudocodeType.INTEGER, (dateValue) =>
		ensureDate(dateValue).getMonth() + 1,
	),
	YEAR: defineBuiltIn([byValue('dateValue', PseudocodeType.DATE)], PseudocodeType.INTEGER, (dateValue) =>
		ensureDate(dateValue).getFullYear(),
	),
	DAYINDEX: defineBuiltIn([byValue('dateValue', PseudocodeType.DATE)], PseudocodeType.INTEGER, (dateValue) =>
		ensureDate(dateValue).getDay() + 1,
	),
