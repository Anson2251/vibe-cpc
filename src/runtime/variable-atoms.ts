...
export class IntegerAtom extends VariableAtom {
    ...
    convertValue(value: unknown): unknown {
        ...
        throw new RuntimeError(
            `Cannot convert value '${String(value)}' of type ${typeof value} to INTEGER`,
        );
    }
    ...
    compareTo(other: VariableAtom): ComparisonResult {
        if (other instanceof IntegerAtom) {
            const thisVal = ensureNumber(this._value, "IntegerAtom.compareTo(this)");
            const otherVal = ensureNumber(other.value, "IntegerAtom.compareTo(other)");
    ...
    add(other: IntegerAtom | RealAtom): IntegerAtom | RealAtom {
        if (other instanceof IntegerAtom) {
            return new IntegerAtom(
                ensureNumber(this._value, "IntegerAtom.add(this)") +
                    ensureNumber(other.value, "IntegerAtom.add(other)"),
            );
    ...
    subtract(other: IntegerAtom | RealAtom): IntegerAtom | RealAtom {
        if (other instanceof IntegerAtom) {
            return new IntegerAtom(
                ensureNumber(this._value, "IntegerAtom.subtract(this)") -
                    ensureNumber(other.value, "IntegerAtom.subtract(other)"),
            );
        } else if (other instanceof RealAtom) {
            return new RealAtom(
                ensureNumber(this._value, "IntegerAtom.subtract(this)") -
    ...
    multiply(other: IntegerAtom | RealAtom): IntegerAtom | RealAtom {
        if (other instanceof IntegerAtom) {
            return new IntegerAtom(
                ensureNumber(this._value, "IntegerAtom.multiply(this)") *
                    ensureNumber(other.value, "IntegerAtom.multiply(other)"),
            );
        } else if (other instanceof RealAtom) {
            return new RealAtom(
                ensureNumber(this._value, "IntegerAtom.multiply(this)") *
    ...
    divide(other: IntegerAtom | RealAtom): RealAtom {
        if (other instanceof IntegerAtom) {
            const divisor = ensureNumber(other.value, "IntegerAtom.divide(other)");
            if (divisor === 0) throw new RuntimeError(`Division by zero`);
            return new RealAtom(ensureNumber(this._value, "IntegerAtom.divide(this)") / divisor);
        } else if (other instanceof RealAtom) {
            const divisor = ensureNumber(other.value, "IntegerAtom.divide(other)");
            if (divisor === 0) throw new RuntimeError(`Division by zero`);
            return new RealAtom(ensureNumber(this._value, "IntegerAtom.divide(this)") / divisor);
    ...
    integerDivide(other: IntegerAtom): IntegerAtom {
        if (other instanceof IntegerAtom) {
            const divisor = ensureNumber(other.value, "IntegerAtom.integerDivide(other)");
            if (divisor === 0) throw new RuntimeError(`Division by zero`);
            return new IntegerAtom(
                Math.floor(ensureNumber(this._value, "IntegerAtom.integerDivide(this)") / divisor),
            );
        }
    ...
    mod(other: IntegerAtom): IntegerAtom {
        if (other instanceof IntegerAtom) {
            const divisor = ensureNumber(other.value, "IntegerAtom.mod(other)");
            if (divisor === 0) throw new RuntimeError(`Modulo by zero`);
            return new IntegerAtom(ensureNumber(this._value, "IntegerAtom.mod(this)") % divisor);
        }
...
export class RealAtom extends VariableAtom {
    ...
    convertValue(value: unknown): unknown {
        ...
        throw new RuntimeError(
            `Cannot convert value '${String(value)}' of type ${typeof value} to REAL`,
        );
    }
    ...
    compareTo(other: VariableAtom): ComparisonResult {
        if (other instanceof RealAtom || other instanceof IntegerAtom) {
            const thisVal = ensureNumber(this._value, "RealAtom.compareTo(this)");
            const otherVal = ensureNumber(other.value, "RealAtom.compareTo(other)");
    ...
    add(other: IntegerAtom | RealAtom): RealAtom {
        if (other instanceof IntegerAtom || other instanceof RealAtom) {
            return new RealAtom(
                ensureNumber(this._value, "RealAtom.add(this)") +
                    ensureNumber(other.value, "RealAtom.add(other)"),
            );
        }
    ...
    subtract(other: IntegerAtom | RealAtom): RealAtom {
        if (other instanceof IntegerAtom || other instanceof RealAtom) {
            return new RealAtom(
                ensureNumber(this._value, "RealAtom.subtract(this)") -
                    ensureNumber(other.value, "RealAtom.subtract(other)"),
            );
        }
    ...
    multiply(other: IntegerAtom | RealAtom): RealAtom {
        if (other instanceof IntegerAtom || other instanceof RealAtom) {
            return new RealAtom(
                ensureNumber(this._value, "RealAtom.multiply(this)") *
                    ensureNumber(other.value, "RealAtom.multiply(other)"),
            );
        }
    ...
    divide(other: IntegerAtom | RealAtom): RealAtom {
        if (other instanceof IntegerAtom || other instanceof RealAtom) {
            const divisor = ensureNumber(other.value, "RealAtom.divide(other)");
            if (divisor === 0) throw new RuntimeError(`Division by zero`);
            return new RealAtom(ensureNumber(this._value, "RealAtom.divide(this)") / divisor);
        }
...
export class CharAtom extends VariableAtom {
    ...
    convertValue(value: unknown): unknown {
        ...
        throw new RuntimeError(
            `Cannot convert value '${String(value)}' of type ${typeof value} to CHAR`,
        );
    }
    ...
    compareTo(other: VariableAtom): ComparisonResult {
        if (other instanceof CharAtom) {
            const thisVal = ensureString(this._value, "CharAtom.compareTo(this)");
            const otherVal = ensureString(other.value, "CharAtom.compareTo(other)");
...
export class StringAtom extends VariableAtom {
    ...
    compareTo(other: VariableAtom): ComparisonResult {
        if (other instanceof StringAtom) {
            const thisVal = ensureString(this._value, "StringAtom.compareTo(this)");
            const otherVal = ensureString(other.value, "StringAtom.compareTo(other)");
...
export class BooleanAtom extends VariableAtom {
    ...
    convertValue(value: unknown): unknown {
        ...
        throw new RuntimeError(
            `Cannot convert value '${String(value)}' of type ${typeof value} to BOOLEAN`,
        );
    }
    ...
    compareTo(other: VariableAtom): ComparisonResult {
        if (other instanceof BooleanAtom) {
            const thisVal = ensureBoolean(this._value, "BooleanAtom.compareTo(this)");
            const otherVal = ensureBoolean(other.value, "BooleanAtom.compareTo(other)");
...
export class DateAtom extends VariableAtom {
    ...
    convertValue(value: unknown): unknown {
        ...
        throw new RuntimeError(
            `Cannot convert value '${String(value)}' of type ${typeof value} to DATE`,
        );
    }
    ...
    compareTo(other: VariableAtom): ComparisonResult {
        if (other instanceof DateAtom) {
            const thisVal = ensureDate(this._value, "DateAtom.compareTo(this)");
            const otherVal = ensureDate(other.value, "DateAtom.compareTo(other)");
...
export class ArrayAtom extends VariableAtom {
    ...
    copy(): VariableAtom {
        ...
        const copiedUnknown: unknown = JSON.parse(JSON.stringify(this._value));
        const copiedValue = ensureArray(copiedUnknown, "ArrayAtom.copy");
    ...
    compareTo(other: VariableAtom): ComparisonResult {
        if (other instanceof ArrayAtom) {
            ...
            const thisArray = ensureArray(this._value, "ArrayAtom.compareTo(this)");
            const otherArray = ensureArray(other.value, "ArrayAtom.compareTo(other)");
        ...
        if (dimension < this._arrayType.bounds.length - 1) {
            for (const element of array) {
                if (Array.isArray(element)) {
                    ...
                    throw new RuntimeError(
                        `Expected ${this._arrayType.bounds.length - dimension} more dimensions`,
                    );
                }
            }
        }
...
export class UserDefinedAtom extends VariableAtom {
    ...
    validateValue(value: unknown): void {
        ...
        for (const [fieldName, fieldType] of Object.entries(this._userDefinedType.fields)) {
            if (!(fieldName in value)) {
                throw new RuntimeError(
                    `Missing field '${fieldName}' in user-defined type '${this._userDefinedType.name}'`,
                );
            }
    ...
    copy(): VariableAtom {
        ...
        const copiedUnknown: unknown = JSON.parse(JSON.stringify(this._value));
        if (!isRecord(copiedUnknown)) {
            throw new RuntimeError("UserDefinedAtom.copy expected object");
        }
        const copiedValue = copiedUnknown;
    ...
    compareTo(other: VariableAtom): ComparisonResult {
        if (other instanceof UserDefinedAtom && other.typeName === this.typeName) {
            ...
            if (!isRecord(this._value) || !isRecord(other.value)) {
                throw new RuntimeError("UserDefinedAtom.compareTo expected object values");
            }
            const thisObj = this._value;
            const otherObj = other.value;
        ...
        throw new RuntimeError(
            `Cannot compare user-defined type '${this.typeName}' with unsupported type`,
        );
    }
    ...
    private validateFieldValue(value: unknown, fieldType: TypeInfo): void {
        if (typeof fieldType === "string") {
            ...
            if (typeof value !== "object" || value === null) {
                throw new RuntimeError(
                    `Expected user-defined type '${fieldType.name}', got ${typeof value}`,
                );
            }
        }
    }
...
export class EnumAtom extends VariableAtom {
    ...
    compareTo(other: VariableAtom): ComparisonResult {
        ...
        throw new RuntimeError(
            `Cannot compare enum '${this._enumType.name}' with unsupported type`,
        );
    }
}
...
export class SetAtom extends VariableAtom {
    ...
    compareTo(other: VariableAtom): ComparisonResult {
        ...
        const a = ensureSet(this._value, "SetAtom.compareTo(this)").size;
        const b = ensureSet(other.value, "SetAtom.compareTo(other)").size;
        if (a < b) return ComparisonResult.LESS_THAN;
        if (a > b) return ComparisonResult.GREATER_THAN;
        return ComparisonResult.EQUAL;
    }
...
export class VariableAtomFactory {
     ...
     */
    static createAtom(type: TypeInfo, value: unknown, isConstant: boolean = false): VariableAtom {
        if (typeof type === "string") {
            ...
            switch (type) {
                ...
                default:
                    throw new RuntimeError(`Unsupported type: ${String(type)}`);
            }
