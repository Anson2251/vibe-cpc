...
export class NodeIOImpl implements IOInterface {
    ...
    async appendFile(path: string, data: string): Promise<void> {
        try {
            ...
            throw new Error(
                `Failed to append to file '${path}': ${error instanceof Error ? error.message : String(error)}`,
            );
        }
    }
    ...
    async openRandomFile(path: string): Promise<number> {
        try {
            ...
            throw new Error(
                `Failed to open random file '${path}': ${error instanceof Error ? error.message : String(error)}`,
            );
        }
    }
    ...
    async readRecord(fileHandle: number, position: number): Promise<string> {
        ...
        try {
            ...
            throw new Error(
                `Failed to read record at position ${position}: ${error instanceof Error ? error.message : String(error)}`,
            );
        }
    }
    ...
    async writeRecord(fileHandle: number, position: number, data: string): Promise<void> {
        ...
        try {
            ...
            throw new Error(
                `Failed to write record at position ${position}: ${error instanceof Error ? error.message : String(error)}`,
            );
        }
    }
    ...
    async closeFile(fileHandle: number): Promise<void> {
        ...
        try {
            ...
            throw new Error(
                `Failed to close file handle ${fileHandle}: ${error instanceof Error ? error.message : String(error)}`,
            );
        }
    }
