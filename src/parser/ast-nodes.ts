    ...
    visit(node: ASTNode): T {
        switch (node.type) {
            ...
            case "ProcedureDeclaration":
                return this.visitProcedureDeclaration(node as ProcedureDeclarationNode);
            case "FunctionDeclaration":
                return this.visitFunctionDeclaration(node as FunctionDeclarationNode);
            case "CallStatement":
                return this.visitCallStatement(node as CallStatementNode);
            case "Input":
            ...
            case "OpenFile":
                return this.visitOpenFile(node as OpenFileNode);
            case "CloseFile":
                return this.visitCloseFile(node as CloseFileNode);
            case "ReadFile":
                return this.visitReadFile(node as ReadFileNode);
            case "WriteFile":
                return this.visitWriteFile(node as WriteFileNode);
            case "Seek":
                return this.visitSeek(node as SeekNode);
            case "GetRecord":
                return this.visitGetRecord(node as GetRecordNode);
            case "PutRecord":
                return this.visitPutRecord(node as PutRecordNode);
            case "TypeDeclaration":
                return this.visitTypeDeclaration(node as TypeDeclarationNode);
            case "SetDeclaration":
                return this.visitSetDeclaration(node as SetDeclarationNode);
            case "FieldDeclaration":
                return this.visitFieldDeclaration(node as FieldDeclarationNode);
            ...
            case "MemberAccess":
                return this.visitMemberAccess(node as MemberAccessNode);
            case "NewExpression":
                return this.visitNewExpression(node as NewExpressionNode);
            case "TypeCast":
            ...
            case "EOF":
                return this.visitEOF(node as EOFNode);
            default:
